...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageFileUploading) {
      setUpdateUserError("Please wait for image to upload completely");
      return;
    }
    try {
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        />
        <div
          className="relative w-36 h-36 self-center cursor-pointer shadow-md overflow-hidden rounded-full"
        ...
        >
          ...
          <img
            ...
            alt="user"
            className={`rounded-full w-full h-full border-2 p-1 border-indigo-400 object-cover ${
              imageFileUploadProgress &&
              imageFileUploadProgress < 100 &&
              "opacity-60"
            }`}
